<template>
  <div class="add-monitor-container">
    ...
    <el-steps class="step-bar" :space="400" :active="active" finish-status="success" simple>
  ...
  export default {
    ...
    methods: {
      ...
      createStateFilter(queryString) {
        return contact => contact.value.toLowerCase().indexOf(queryString.toLowerCase()) === 0
